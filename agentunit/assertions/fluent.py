"""Fluent assertion API for AgentUnit.
...
from agentunit.assertions.behavior import ToolAssertion, TraceAssertion
...
def expect(trace: AgentTrace) -> ExpectTrace:
    ...
    This is the primary entry point for all AgentUnit assertions.

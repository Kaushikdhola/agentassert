"""Decorators for AgentUnit test and fixture definitions."""
...
def scenarios(values: list[Scenario]) -> Callable[[F], F]:
    ...
    def decorator(func: F) -> F:
        setattr(func, "__agentunit_scenarios__", values)
        return func
...
def agent_test(func: F) -> F:
    """
    Mark a function as an AgentUnit test.
    ...
    setattr(wrapper, "__agentunit_test__", True)
    return wrapper  # type: ignore[return-value]


def fixture(func: F) -> F:
    """
    Mark a function as an AgentUnit fixture.
    ...
    setattr(wrapper, "__agentunit_fixture__", True)
    return wrapper  # type: ignore[return-value]

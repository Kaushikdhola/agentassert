...
from agentassert.adapters.generic import GenericAdapter
from agentassert.mocks.tool_mock import set_active_tracer
...
class AgentHarness:
    """
    Test harness responsible for running an agent under AgentAssert control.

"""Run command for AgentAssert CLI.

Usage:
    agentassert run [PATH] [OPTIONS]

Examples:
    agentassert run                    # Run all tests in current directory
    agentassert run tests/             # Run tests in tests/ directory
    agentassert run tests/test_foo.py  # Run tests in specific file
    agentassert run -k "search"        # Run tests matching "search"
    agentassert run -v                 # Verbose output
"""

"""AgentAssert CLI main entry point.

Usage:
    agentassert run [PATH] [OPTIONS]
    agentassert replay TRACE_ID
    agentassert --help
...
@click.group()
@click.version_option(version=__version__, prog_name="agentassert")
def main() -> None:
    """
...
from agentassert.cli.commands.run import run as run_cmd
